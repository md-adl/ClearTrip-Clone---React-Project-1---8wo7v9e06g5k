...
const FlightCheckOut = () => {
  ...
  return (
    <Stack>
      <Navbar />
      <Stack direction={{ xs: "column", md: "row" }} px={2} py={10} spacing={2}>
                ...
                >
                  <Stack py={2}>
                    <Stack direction="row" alignItems="center" spacing={1}>
                      <Typography sx={{ fontWeight: "bold" }}>
                        {
                          cities.find(
                            (city) => city.code === flightData.item.source
                          ).name
                        }
                      </Typography>
                      ...
                      <Typography sx={{ fontWeight: "bold" }}>
                        {
                          cities.find(
                            (city) => city.code === flightData.item.destination
                          ).name
                        }
                      </Typography>
                      <Typography style={{ marginLeft: "10px", color: "#999" }}>
                        {flightData.day}
                      </Typography>
                    </Stack>
                    <Stack
                  ...
                  <Stack py={3}>
                    ...
                    <Stack
                      ...
                      sx={{ border: "0.5px solid #e6e6e6", borderTop: "none" }}
                    >
                      <Stack>
                        <Typography>
                          Cancellation fee starts from ₹3,550
                        </Typography>
                        <Typography>
                          {" "}
                          Date change allowed from ₹3,050
                        </Typography>
                      </Stack>
                      <Stack>
                ...
                optional={
                  activeStep === 1 ? (
                    <Typography variant="caption" marginLeft="10px">
                      E-ticket will be sent to this email address and phone
                      number
                    </Typography>
                  ) : null
                }
